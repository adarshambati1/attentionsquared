...
CONFIG = Path("configs/004_functional_v5_phase12.json")
OUTPUT_ROOT = Path("/workspace/functional_phase12_v5_native")
EXPECTED_PHASE11_PROTOCOL = "functional-eight-example-overfit-cache-v5-native-coda-v2"
...
def validate_config(config: dict) -> None:
    expected = {
        ...
        "phase11_model": "/workspace/functional_overfit_v5_native_v2/model.pt",
        "phase11_model_sha256": "caf5cd7d56a6491660ccdd7a0722407c2175ba5641faf7f462fac0cde2446731",
        "phase11_result": "/workspace/functional_overfit_v5_native_v2/result.json",
        "phase11_result_sha256": "522d8ea2de814393f443f8b50fed84d4cd0ff9f44254d556a620adbdfd89a8a0",
...
def run(config: dict, commit: str) -> dict:
    ...
    if sha256_file(cache_root / "manifest.json") != config["cache_manifest_sha256"]:
        raise ValueError("cache-v5 manifest identity mismatch")
