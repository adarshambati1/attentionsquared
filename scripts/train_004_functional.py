#!/usr/bin/env python3
"""Functional-only A² training: teacher-logit KL, no trajectory targets."""
...
def main(config,cache,output,steps):
 ...
 tok_results=[]; output.mkdir(parents=True,exist_ok=True)
 for k in [1,2,4]:
