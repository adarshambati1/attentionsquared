...
CONFIG = Path("configs/004_functional_v5_overfit.json")
OUTPUT_ROOT = Path("/workspace/functional_overfit_v5_native")
...
OVERFIT_PROTOCOL = "functional-eight-example-overfit-cache-v5-native-coda-v1"
PRELAUNCH_PROTOCOL = "functional-eight-example-overfit-cache-v5-native-coda-v1-prelaunch-v1"
