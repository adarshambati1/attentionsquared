...
def main():
 ...
 gsm_names=expected_conditions['gsm8k'][:6];gsm_comparisons=[('current_d8','plain_d8'),('projected_uniform_d8','current_d8'),('shared_d8','current_d8'),('per_layer_d8','current_d8'),('shared_d8','plain_d8'),('per_layer_d8','plain_d8'),('plain_d16','plain_d8')];table1,paired1=paired_block('gsm8k',gsm_names,gsm_comparisons,0)
 table2={};paired2={}
 for offset,dataset in enumerate(('gsm8k','svamp','math500'),10):
  names=['plain_d8','current_d8','shared_d8','plain_d16'];vals,pairs=paired_block(dataset,names,[('current_d8','plain_d8'),('shared_d8','current_d8'),('shared_d8','plain_d8'),('plain_d16','plain_d8')],offset);table2[dataset]=vals;paired2[dataset]=pairs
 table3={};paired3={}
